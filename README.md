# BAN 6003 Weeks 1-2: Codespaces, Python, Pandas, and First Data Profile

**BAN 6003: Data Management and Analytics Integration**  
**Weeks 1-2 GitHub Classroom Template**
...
- `notebooks/Week2_lab1_python_pandas_guided_lab.ipynb`
- `notebooks/Week2_assignment.ipynb`
...
```bash
git add .
git commit -m "Complete Weeks 1-2 BAN 6003 assignment"
git push
```
